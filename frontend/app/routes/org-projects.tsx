                ...
                <div key={project.id} className="relative group rounded-3xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6 shadow-sm transition hover:shadow-md hover:border-slate-300 dark:hover:border-slate-600 hover:-translate-y-0.5 duration-150">
                  ...
                  <button className="w-full text-left" onClick={() => handleSelect(project)}>
                    <div className="flex items-start gap-3 mb-4">
                      <div className="flex h-10 w-10 flex-none items-center justify-center rounded-2xl bg-blue-100 dark:bg-blue-950 text-blue-900 dark:text-blue-300 border border-blue-200 dark:border-blue-800 text-xs font-bold">
                    ...
                    {(project.teams?.length ?? 0) > 0 && (
                      <div className="flex flex-wrap gap-1.5 mt-2">
                        {project.teams!.map((t) => (
                          <span key={t.id} className="inline-flex items-center rounded-lg bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 px-2 py-1 text-xs font-medium text-slate-600 dark:text-slate-300">
                            {t.name}
                          </span>
                        ))}
                      </div>
