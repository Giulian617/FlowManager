...
import {
  CheckSquare, ArrowLeft, ChevronDown, Search, UserCircle,
    ...
    <div className="space-y-6">
      <header className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-sky-50 border border-sky-200">
          ...
          <div>
            ...
            <h1 className="text-2xl font-semibold text-slate-900">Task</h1>
          </div>
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_300px]">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Provide context, steps, or any relevant details…" 
                rows={6}
        ...
        <div className="space-y-5">
          ...
          <div className="flex flex-col gap-2">
            <button type="button" disabled={!canSave} className="w-full rounded-2xl bg-slate-900 px-5 py-3 text-sm font-semibold text-white transition hover:bg-slate-800 disabled:opacity-40 disabled:cursor-not-allowed">Save Task</button>
